...
- **R18.Reset.1b.hotfix** — Starter Kit Inventory Unique Index Fix (**CLOSED & SEALED 2026-07-05T10:02:00Z**, sibling script `round18_reset1b_apply_v1_1.py` creato, sealed intatto, 12/12 pytest PASS + 9/10 tester independent PASS (WARN fixed pre-seal), gate §16 gate 6 SATISFIED. Registry entry sigillato per PM_authorization.)
