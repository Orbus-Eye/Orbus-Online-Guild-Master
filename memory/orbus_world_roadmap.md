...
| **R18.3b.1** | 🔍 OPEN PENDING (post-R18.3c) | Stat/Role Enum Reconciliation Matrix (audit-only, decision support) — prepara 3-4 opzioni formali PM per: (a) stat system (5-stat legacy vs 6-stat adozione vs mapping esplicito 6→5) (b) role enum (atomic vs composite). Impact tecnico per opzione, backfill count, regression risk. Nessuna implementazione. Deliverable: `round183b1_stat_role_enum_reconciliation_matrix.md`. |
