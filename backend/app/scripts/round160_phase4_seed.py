...
THREATS = [
    ...
    {"slug": "undead", "name_it": "Non-morti", "description_it": "Creature non viventi animate da magia oscura.", "lore_tag": "undead"},
    {"slug": "beast", "name_it": "Bestie", "description_it": "Animali predatori o creature mostruose."},
    {"slug": "elemental", "name_it": "Elementali", "description_it": "Creature di elementi puri (fuoco, ghiaccio, terra, aria)."},
    {"slug": "void", "name_it": "Corruzione del Vuoto", "description_it": "Entità incorporee provenienti dall'Abisso oltre la realtà.", "lore_tag": "void"},
