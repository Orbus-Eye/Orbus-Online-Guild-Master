...
EVENT_TYPES = frozenset({
    ...
    # ROUND 16.5.1 B.1 — world events extension
    "CONTINENT_EVENT_UPDATED",
    "CONTINENT_EVENT_DEACTIVATED",
    "CONTINENT_EVENT_DUPLICATED",
    # ROUND 16.5.1 B.2 — tester tools
    "TESTER_TOOL_INVOKED",
    "TESTER_TOOL_REJECTED",
    "SITE_INCOME_CLAIMED",
